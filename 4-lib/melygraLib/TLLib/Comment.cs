    ...
    public class Comment
    {
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Answer", string.IsNullOrEmpty(Answer) ? dbNULL : (object)Answer);
                cmd.Parameters.AddWithValue("@AnswerEn", string.IsNullOrEmpty(AnswerEn) ? dbNULL : (object)AnswerEn);
