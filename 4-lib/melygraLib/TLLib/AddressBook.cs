...
namespace TLLib
{
    public class AddressBook
    {
        ...
        public int AddressBookSelectIdentCurrent()
        {
            int num;
            try
            {
                ...
                SqlCommand selectCommand = new SqlCommand("usp_AddressBook_SelectIdentCurrent", connection)
                {
                ...
                {
                    throw new Exception("Stored Procedure 'usp_AddressBook_SelectIdentCurrent' reported the ErrorCode : " + parameter.Value.ToString());
                }
