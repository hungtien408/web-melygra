<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="thongtinwebsite.aspx.cs" Inherits="ad_single_product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                                                ...
                                                <table class="search">
                                                    <tr class="invisible">
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 440px x 300px)</span>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter DefaultValue="20" ControlID="ddlSearchCategory" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ProductCategorySelectAll"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="20" Name="parentID" Type="Int32" />
