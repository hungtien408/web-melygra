<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="order.aspx.cs" Inherits="ad_single_order" %>
        ...
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            <table class="search">
                <tr>
                    ...
                    <td class="invisible">
                        <asp:RadTextBox ID="txtSearchUserName" runat="server" Width="130px" EmptyMessage="Tài khoản...">
                        </asp:RadTextBox>
                    </td>
                    <td class="left invisible">
                        Từ Ngày
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"  PageSize="20" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="OdsOrder" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="FirstName" HeaderText="Họ Tên" SortExpression="FirstName">
                        <ItemTemplate>
                            <div align="left">
                    ...
                    <asp:GridTemplateColumn DataField="UserName" HeaderText="UserName" SortExpression="UserName" Visible="False">
                        <ItemTemplate>
                            <div align="left">
                    ...
                    <asp:GridTemplateColumn DataField="DeliveryAddress" HeaderText="Địa chỉ" SortExpression="DeliveryAddress">
                        <ItemTemplate>
                            <div align="left">
                    ...
                    <asp:GridTemplateColumn DataField="ProvinceName,DistrictName" HeaderText="Tỉnh/Thành Quận/Huyện"
                        SortExpression="ProvinceName,DistrictName">
                        <ItemTemplate>
                            <div align="center">
                    ...
                    <asp:GridTemplateColumn DataField="HomePhone" HeaderText="Điện thoại" SortExpression="HomePhone">
                        <ItemTemplate>
                            <div align="left">
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="Tình trạng đơn hàng" DataField="OrderStatusID"
                        ...
                        <ItemTemplate>
                            <asp:RadComboBox ID="ddlOrderStatus" runat="server" CssClass="dropdownlist" DataSourceID="OdsOrderStatus"
                                ...
                                OnDataBound="DropDownList_DataBound" Width="80px" EmptyMessage="- Chọn -">
                            </asp:RadComboBox>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="Hình thức thanh toán"
                        DataField="PaymentMethodID" SortExpression="PaymentMethodID" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="Tình trạng thanh toán"
                        DataField="PayStatusID" SortExpression="PayStatusID" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="Tình trạng vận chuyển"
                        DataField="ShippingStatusID" SortExpression="ShippingStatusID" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:GridBoundColumn DataField="UserName" Visible="False" HeaderText="UserName" HeaderStyle-Width="5%"
                        SortExpression="UserName">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn DataField="ServiceID" HeaderText="Thanh toán" Visible="False"
                    ...
                    <table cellspacing="5" cellpadding="5">
                        <tr>
                            ...
                            <td style="border: 1px solid #ccc" valign="top" class="invisible">
                                ...
                                <asp:ObjectDataSource ID="OdsShippingAddress" runat="server" SelectMethod="AddressBookSelectOne"
                            ...
                            <td style="border: 1px solid #ccc" valign="top" class="invisible">
                                ...
                                <asp:ObjectDataSource ID="OdsBillingAddress" runat="server" SelectMethod="AddressBookSelectOne"
                                    TypeName="TLLib.AddressBook">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="hdnShippingAddressID" DefaultValue="-1" Name="AddressBookID"
                                            PropertyName="Value" Type="String" />
