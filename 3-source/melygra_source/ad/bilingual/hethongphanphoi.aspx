<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="hethongphanphoi.aspx.cs" Inherits="ad_single_article" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="AddressBookID" SortExpression="AddressBookID">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="Company" HeaderText="Tên Nhà Thuốc" SortExpression="Company" />
                    <asp:GridBoundColumn DataField="ProvinceName" HeaderText="Thành Phố" SortExpression="ProvinceName" />
                    <asp:GridBoundColumn DataField="DistrictName" HeaderText="Quận" SortExpression="DistrictName" />
                    ...
                    <asp:GridTemplateColumn DataField="IsPrimary" HeaderText="Hiển thị" SortExpression="IsPrimary">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsAvailable" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsPrimary").ToString()) ? false : Eval("IsPrimary") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">
                                Thông Tin Hệ Thông Phân Phối</h3>
                            <asp:HiddenField ID="hdnAddressBookID" runat="server" Value='<%# Eval("AddressBookID") %>' />
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    <td class="left" colspan="2">
                                        ...
                                        <asp:CheckBox ID="chkIsAvailable" runat="server" CssClass="checkbox" Text=" Hiển thị"
                                            Checked='<%# (Container is GridEditFormInsertItem) ? true : (string.IsNullOrEmpty(Eval("IsPrimary").ToString()) ? false : Eval("IsPrimary")) %>' />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left">
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlProvince" runat="server" DataSourceID="ObjectDataSource2"
                                            DataTextField="ProvinceName" DataValueField="ProvinceID" Width="504px" OnDataBound="DropDownList_DataBound" AutoPostBack="True">
                                        </asp:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlDistrict" runat="server" DataSourceID="ObjectDataSource3"
                                            DataTextField="DistrictName" DataValueField="DistrictID" Width="504px" OnDataBound="DropDownList_DataBound">
                                        </asp:RadComboBox>
                                        <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="DistrictSelectAll"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCompany" runat="server" Text='<%# Bind("Company") %>' Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCompanyEn" runat="server" Text='<%# Bind("CompanyEn") %>' Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtAddressEn" runat="server" Text='<%# Bind("Address2") %>' Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <%--<tr>
                                    <td class="left" valign="top">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="AddressBook1SelectAll"
        ...
        InsertMethod="AddressBook1Insert">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="CompanyEn" Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ProvinceSelectAll"
