            ...
            <ContentTemplate>
                ...
                <option value="">Loại 3</option>
                    ...
                    <asp:DropDownList ID="dropListLoaiHang" CssClass="selectb" runat="server" DataSourceID="odsLoaiHang"
                        DataTextField="ProductName" DataValueField="ProductID" AutoPostBack="True" OnSelectedIndexChanged="dropListLoaiHang_SelectedIndexChanged">
                ...
                <div class="popup-w">
                    <div class="table-book table-responsive">
                        ...
                        <asp:ListView ID="ListView1" runat="server" DataSourceID="odsCart" EnableModelValidation="True" OnItemCommand="ListView1_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    <td class="book-name1">
                                        <%# Eval("ProductName")%>
        ...
        <div class="popup-w">
            <div class="popup-btn">
                <asp:Button ID="btGui" ValidationGroup="SendEmail" OnClick="btGui_Click" CssClass="button-btn"
                    runat="server" Text="TIẾN HÀNH ĐẶT HÀNG" />
            </div>
        </div>
    </div>
