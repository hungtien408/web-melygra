<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="bi-kip-phong-the-chi-tiet.aspx.cs" Inherits="bi_kip_phong_the_chi_tiet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div class="colContent">
       ...
       <div class="file-pdf">
            <a class="media" href="assets/images/pdf.pdf"></a>
       </div>
     </div>
     <div class="colAside">
        <div class="book-onl">
         ...
         <div class="video-main">
          ...
          <div class="recipe-aside">
            <div class="rec-img">
                <a href="#"><img src="assets/images/rec2.png" alt=""/></a>
            </div>
            <div class="rec-name">
